...
| Low | **Deprecate `contextData` JSON column** on the audit log once all callers have migrated to the typed report columns (Phase 2 of this feature). |
