...
public class RemovePermissionsCommandHandlerTest {
    ...
    @InjectMocks
    private RemovePermissionsCommandHandler removePermissionsCommandHandler;
    ...
    void testHandle() {
        ...
        //
        // When
        // ResponseEntity<[object Object]> response = removePermissionsCommandHandler.handle(command);
        //
        // Then
