...
public class UpdatePermissionCommandHandlerTest {
    ...
    @InjectMocks
    private UpdatePermissionCommandHandler updatePermissionCommandHandler;
    ...
    void testHandle() {
        ...
        //
        // When
        // ResponseEntity<[object Object]> response = updatePermissionCommandHandler.handle(command);
        //
        // Then
