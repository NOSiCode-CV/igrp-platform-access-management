...
public class GetApplicationByCodeQueryHandlerTest {
  ...
  @Test
  void testHandleGetApplicationByCodeQuery() {
    // TODO: Implement unit test for handle method
    // Example:
    // Given
    // GetApplicationByCodeQuery query = new GetApplicationByCodeQuery(...);
    //
    // When
    // ResponseEntity<String> response = getApplicationByCodeQueryHandler.handle(query);
    //
    // Then
