...
public class GetMenusAvailableForDepartmentQueryHandler implements QueryHandler<GetMenusAvailableForDepartmentQuery, ResponseEntity<List<MenuEntryDTO>>> {
    ...
    public GetMenusAvailableForDepartmentQueryHandler(MenuEntryEntityRepository menuEntryEntityRepository, MenuEntryMapper menuEntryMapper, DepartmentEntityRepository departmentEntityRepository) {
