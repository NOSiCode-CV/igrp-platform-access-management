 ...
 * This query handler:
 * <ul>
 *   <li>Uses the {@link ApplicationRepository} to fetch applications not assigned to the user via roles and departments.</li>
 *   <li>Maps the resulting {@link Application} entities to {@link ApplicationDTO} objects using {@link ApplicationMapper}.</li>
