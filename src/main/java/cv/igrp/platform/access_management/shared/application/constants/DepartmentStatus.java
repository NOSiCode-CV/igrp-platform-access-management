...
public enum DepartmentStatus implements IgrpEnum<String> {
  ...
  */
  private static final Map<String, DepartmentStatus> CODE_MAP = Arrays.stream(values())
          .collect(Collectors.toMap(DepartmentStatus::getCode, Function.identity()));
  ...
  */
  public static Optional<DepartmentStatus> fromCode(String code) {
  ...
  */
  public static DepartmentStatus fromCodeOrThrow(String code) {
    return fromCode(code).orElseThrow(() -> new IllegalArgumentException("Invalid DepartmentStatus for this code: " + code));
  }
  ...
  */
  public static Map<String, String> codeDescriptionMap() {
    return CODE_MAP.values().stream().collect(Collectors.toMap(DepartmentStatus::getCode, DepartmentStatus::getDescription));
  }
