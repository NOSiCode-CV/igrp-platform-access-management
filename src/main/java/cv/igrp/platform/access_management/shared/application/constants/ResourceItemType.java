...
public enum ResourceItemType implements IgrpEnum<String> {
  ...
  */
  private static final Map<String, ResourceItemType> CODE_MAP = Arrays.stream(values())
          .collect(Collectors.toMap(ResourceItemType::getCode, Function.identity()));
  ...
  */
  public static Optional<ResourceItemType> fromCode(String code) {
  ...
  */
  public static ResourceItemType fromCodeOrThrow(String code) {
    return fromCode(code).orElseThrow(() -> new IllegalArgumentException("Invalid ResourceItemType for this code: " + code));
  }
  ...
  */
  public static Map<String, String> codeDescriptionMap() {
    return CODE_MAP.values().stream().collect(Collectors.toMap(ResourceItemType::getCode, ResourceItemType::getDescription));
  }
