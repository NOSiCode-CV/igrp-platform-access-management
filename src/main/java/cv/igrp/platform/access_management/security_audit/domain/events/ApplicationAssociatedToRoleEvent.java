...
/**
 * Published when an application is granted to a department (access scope).
 * Catalog: "Associate application to role". {@code relatedEntity} = department code.
 */
public record ApplicationAssociatedToRoleEvent(String applicationName, String departmentCode)
