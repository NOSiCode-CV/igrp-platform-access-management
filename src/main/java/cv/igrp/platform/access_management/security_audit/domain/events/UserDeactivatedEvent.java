...
/**
 * Published when a user is deactivated. Catalog: "Deactivate user".
 *
 * <p>TODO(catalog-gap): no publisher wired in Phase 3 — deactivation is currently
 * folded into {@code UpdateUserStatusCommandHandler}. See {@code roadmap.md}.
 */
public record UserDeactivatedEvent(String username) implements SettingsAuditEvent {
