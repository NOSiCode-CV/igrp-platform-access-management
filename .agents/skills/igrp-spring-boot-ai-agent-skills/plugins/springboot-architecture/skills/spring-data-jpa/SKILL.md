...
### iGRP package placement baseline

- `technical`: `...repositories`, `...models`, `...dto`
- `domain-lite`: `<module>.domain.repository` + `<module>.infrastructure.persistence`
- `domain`: `<module>.domain.repository` + `<module>.infrastructure.db.impl`
