...
- verify package structure still matches iGRP style selected for each module:
  - technical (`controllers/services/repositories/models/dto/constants`)
  - domain-lite (`application/domain/infrastructure`)
  - domain (`application/domain/infrastructure` with CQRS/event contracts)
